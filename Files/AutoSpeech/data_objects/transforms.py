...
def generate_test_sequence(feature, partial_n_frames, shift=None):
    while feature.shape[0] <= partial_n_frames:				# Shape of feature: [665, 257]
    ...
    test_sequence = []
    start = 0
    while start + partial_n_frames <= feature.shape[0]:			# The test_seequence will be of shape [600, 257]. It makes the number of rows mulitple of parital_n_frame // 2 
